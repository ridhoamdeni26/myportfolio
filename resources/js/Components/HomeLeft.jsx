        ...
        >
            <div className="title w-full float-left mb-[21px]">
                <h3 className="font-extrabold text-[60px] leading-[70px]">
                    Hi, I'm <span className="text-blue-color">{name}</span>
                </h3>
                <h3 className="font-extrabold text-[60px] leading-[70px]">
            ...
            >
                <p>
                    I'm a {country} based web designer &amp; fullstack developer
                    with{" "}
            ...
            >
                ...
                <motion.div
                    ...
                    whileTap={{ scale: 0.9 }}
                >
                    <a href="https://drive.google.com/uc?export=download&id=1g2UvMWFIdgTbKltUObRQn5XdG1IHSb5r">
                        Download CV
                    </a>
                </motion.div>
            </motion.div>
